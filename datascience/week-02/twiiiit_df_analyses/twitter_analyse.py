...
class TwitterClient():
    # default argument None means it is not compulsory to provide
...
class TweetAnalyzer():
    """
    Function for analyzing and categorizing tweets
    """

    def clean_tweet(self, tweet):
        # removing special chars from a tweet
...
if __name__ == "__main__":
    ...
    # user_timeline is a built in method with strict parameter expectations like screen_name, count
    tweets = api.user_timeline(screen_name="realDonaldTrump", count=200)
    # print(tweets)

    # this dir command helps us to see what type of information can be found in relation to a tweet
    # print(dir(tweets[0]))

    df = tweet_analyzer.tweets_to_data_frame(tweets)
    # creating a new column from the sentiment analyses method using the tweets
    ...
    # Time Series
    # individual data serie plotting
