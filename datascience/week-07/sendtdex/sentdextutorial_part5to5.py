...
# what is the purpose of saving a classifier? how pickle can help us?
# where we should save it in the process?
# Answer: we should not train our classifier every time we test something,
# we should run the training max once per month.
...
# so we can comment out the fit and linreg part because the pickle file contains the train data
...
# so we can start prediction based on the X data
...
# lets populate the dataframe with these dates and the forecast values
